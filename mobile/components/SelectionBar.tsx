  ...
  return (
    ...
    >
      {props.mode === 'selection' && (
        <Text numberOfLines={2} style={{ fontSize: 13, color: colors.ink2 }}>
          {props.text}
        </Text>
      )}
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
        {HIGHLIGHT_COLORS.map((c) => (
          <Pressable
            ...
            style={{ width: 28, height: 28, borderRadius: 14, backgroundColor: c.value, borderWidth: 2, borderColor: colors.paperBg }}
          />
        ))}
        <View style={{ flex: 1 }} />
        {props.mode === 'selection' ? (
          <>
            <Pressable
              ...
              style={{ width: 32, height: 32, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.paperBg2 }}
            >
              <Text style={{ fontSize: 13, fontWeight: '600', color: colors.ink2 }}>G</Text>
            </Pressable>
            <Pressable
